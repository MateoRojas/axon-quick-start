...
public class ChatRoom {
    ...
    /*
    * Separate the decision making from the state changes!
    */
    ...
    public ChatRoom(CreateRoomCommand cmd) {
        ...
        // Invokes the event handlers in this chatroom instance (which take care of the state changes)
        // and schedules the event for publication
